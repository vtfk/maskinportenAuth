 ...
 * @returns {Object}
 */
module.exports = (pfx, passphrase = undefined) => {
  ...
  // Convert a Forge private key to an ASN.1 RSA PrivateKey
  const rsaPrivateKey = forge.pki.privateKeyToAsn1(keyData[0].key)

  // Wrap an RSA PrivateKey ASN.1 object in a PKCS#8 ASN.1 PrivateKeyInfo
