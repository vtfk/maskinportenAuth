...
test('Grant is successfully created, when valid options are provided for PEM', () => {
...
test('Grant is successfully created, when valid options are provided for pfx', () => {
